...
[原文链接](https://www.cnblogs.com/softidea/p/6517959.html)
...
更为详尽的内容可阅读[etcd：从应用场景到实现原理的全方位解读](http://www.infoq.com/cn/articles/etcd-interpretation-application-scenario-implement-principle)一文。
...
![](https://oss.aliyuncs.com/yqfiles/afc65d9b0f2d2a29107773e3c662563bfb2ecb49.png)
...
![](https://oss.aliyuncs.com/yqfiles/1d700b6401f7b95e0d1a4f0d9a69d41a6427eeb7.png)
...
![](https://oss.aliyuncs.com/yqfiles/a71126375be903d8477bcc0476411af57ff544c1.png)
...
![](https://oss.aliyuncs.com/yqfiles/94f36270eb8fd5e75fb744c78b33e7dfa709bd92.png)
...
![](https://oss.aliyuncs.com/yqfiles/de5daff21c3a6ef46d204494a1946bd380ee8296.png)
...
![](https://oss.aliyuncs.com/yqfiles/e53bbd1a314675f6a777e3c0c41705eaf758f6c9.png)
...
- 2）主动发起方发送HTTP GET请求；
- 3）监听方的Handler的ServeHTTP访问被调用(框架层传入http.ResponseWriter和http.Request对象），其中http.ResponseWriter对象作为参数传入Writter-Goroutine（就这么称呼吧），该Goroutine的主循环就是将Raft模块传出的message写入到这个responseWriter对象里；http.Request的成员变量Body传入到Reader-Gorouting(就这么称呼吧），该Gorutine的主循环就是不断读取Body上的数据，decode成message通过Channel传给Raft模块。
...
![](https://oss.aliyuncs.com/yqfiles/6e2b8d477ab1a5834cc131fe07f77716ad565259.png)
